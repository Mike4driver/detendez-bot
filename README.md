...
- **Smart Scheduling**: Configurable posting times for both features
...
```
/birthday-config channel:#birthdays role:@Birthday
```
...
- `recent_content` - Recent facts/questions for variety
...
- **Birthday**: Announcement channel, birthday role
- **Facts/Questions**: Channels and posting times
